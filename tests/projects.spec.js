...
test("edit env var", async () => {
	...
	if (error) console.log(error)
	expect(error).toBe(null)
	expect(data?.url).toContain(endpointMap.editEnvVar({ projectId: "project1", envId: "env1" }))
	expect(data?.query).toEqual({ teamId: "team1" })
...
test("get project domain", async () => {
	...
	if (error) console.log(error)
	expect(error).toBe(null)
	expect(data?.url).toContain(endpointMap.getProjectDomain({projectId:"project1",domain:"domain1"}))
	expect(data?.query).toEqual({ teamId: "team1" })
	expect(data?.method).toEqual("get")
})
...
test("remove project domain", async () => {
	...
	if (error) console.log(error)
	expect(error).toBe(null)
	expect(data?.url).toContain(endpointMap.removeProjectDomain({projectId:"project1",domain:"domain1"}))
	expect(data?.query).toEqual({ teamId: "team1" })
	expect(data?.method).toEqual("delete")
})
...
test("remove env var", async () => {
	...
	if (error) console.log(error)
	expect(error).toBe(null)
	expect(data?.url).toContain(endpointMap.removeEnvVar({projectId:"project1",envKeyOrId:"env1"}))
	expect(data?.query).toEqual({ teamId: "team1" })
	expect(data?.method).toEqual("delete")
})
...
test("get env var value", async () => {
	...
	if (error) console.log(error)
	expect(error).toBe(null)
	expect(data?.url).toContain(endpointMap.getEnvVarValue({projectId: "project1", envId: "env1"}))
	expect(data?.query).toEqual({ teamId: "team1" })
	expect(data?.method).toEqual("get")
})
...
test("update project domain", async () => {
	...
	if (error) console.log(error)
	expect(error).toBe(null)
	expect(data?.url).toContain(endpointMap.updateProjectDomain({projectId: "project1", domain: "google.com"}))
	expect(data?.query).toEqual({ teamId: "team1" })
	expect(data?.method).toEqual("patch")
})
...
test("verify project domain", async () => {
	...
	if (error) console.log(error)
	expect(error).toBe(null)
	expect(data?.url).toContain(endpointMap.verifyProjectDomain({projectId:"project1",domain:"domain1"}))
	expect(data?.query).toEqual({ teamId: "team1" })
	expect(data?.method).toEqual("post")
})